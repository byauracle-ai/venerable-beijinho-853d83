...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: 'ÉDEN ESTATES — Boutique Villas, Mauritius' },
      { name: 'description', content: 'Ultra-luxury boutique villas in Mauritius. Starting from $1,250,000. Residency permit included. 0% capital gains tax.' },
